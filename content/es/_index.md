  ...
  - block: slider
    content:
      ...
      - title: <span style="font-size:90%;">Home</span>
        content: <span style="font-size:70%"> Bienvenido a la página de SEOYEON [seoharu.github.io]!</span>
        align: center
        background:
          image:
            filename: me.png
      ...
      - title: <span style="font-size:90%;">About</span>
        content: <span style="font-size:70%">Un resumen del menú de la página de inicio, submenús. </span>
        align: center
        background:
          image:
            filename: me.png
      ...
      - title: <span style="font-size:90%">Research</span>
        content: <span style="font-size:70%">Acerca de mi trabajo como estudiante de investigación en el laboratorio de Inteligencia Artificial Médica y mis intereses de investigación.</span>
        align: center
        background:
          image:
      ...
      - title: <span style="font-size:90%">Medical AI</span>
        content: <span style="font-size:70%">Investigadores universitarios en el Laboratorio de Inteligencia Artificial Médica<span style="font-size:70%">
        align: center
        background:
          image:
            caption: 'Image credit: [**Unsplash**](https://unsplash.com)'
    ...
    content:
      ...
      items:
        ...
        - name: etc
          icon: globe
          icon_pack: fab
          description:  <span style="font-size:90%">Antiguo estudiante de intercambio de la UM y Estudio español</span><br><br>
